...
extension AppController {
    ...
    fileprivate func generateTabBarController() -> UITabBarController {
        ...
        let customTabBarItemOne = UITabBarItem(title: "TEST", image: #imageLiteral(resourceName: "redTab"), selectedImage: nil)
        let customTabBarItemTwo = UITabBarItem(title: "TEST", image: #imageLiteral(resourceName: "greenTab"), selectedImage: nil)
        let customTabBarItemThree = UITabBarItem(title: "TEST", image: #imageLiteral(resourceName: "blueTab"), selectedImage: nil)
